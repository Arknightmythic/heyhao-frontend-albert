          ...
          <header className="flex items-center justify-between relative z-30">
            ...
            >
              <button
                ...
                className={`leading-[20px] transition-all duration-300 px-[26.5px] py-[14px] rounded-xl ${tab ==="GROUP"?" bg-heyhao-blue font-medium hover:bg-heyhao-blue hover:text-white text-white":" hover:bg-heyhao-blue bg-white font-medium hover:text-white text-heyhao-secondary"}`}
              >
                Groups
              </button>
              <button
                ...
                onClick={()=>setTab("PEOPLE")}
                 className={`leading-[20px] transition-all duration-300 px-[26.5px] py-[14px] rounded-xl ${tab ==="PEOPLE"?" bg-heyhao-blue font-medium hover:bg-heyhao-blue hover:text-white text-white":" hover:bg-heyhao-blue bg-white font-medium hover:text-white text-heyhao-secondary"}`}
              >
                People
              </button>
            </div>
              ...
              {groups.data?.map((item) => (
                <GroupCard
                  ...
                  data={{
                    ...
                    type: item.type,
                    totalMembers: item.room._count.members,
                  }}
                />
              ))}
            </div>
